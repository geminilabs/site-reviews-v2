...
echo "Remote SVN repo on WordPress.org. No trailing slash."
...
echo "Your local plugin root directory, the Git repo. No trailing slash."
...
printf "Name of the main plugin file ($default_mainfile): "
read -e input
